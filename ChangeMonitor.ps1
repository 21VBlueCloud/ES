...
$Tenants = @()
$result = ""
$Tenants= Get-Organization -Filter "WhenCreated -gt '$($date_day)'" -AccountPartition 'ForestName'|?{$_.Name -match 'onmschina'}
...
$mbCred = new-object Management.Automation.PSCredential “Account”, (“PSW” | ConvertTo-SecureString -AsPlainText -Force)
